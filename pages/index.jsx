...
import gear from "../pages/components/images/gears.png";
import cover2 from "../pages/components/images/cover2.jpg";
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="The minimum price for our work is between $60 and $100.It&apos;s price depends on the job.We provide three to six months warranty."
        />
        <meta
          name="keywords"
      ...
      <main>
        ...
        <section className="container">
          <div className="row align-items-center my-lg-5 my-0">
            ...
            <div className="col-lg-6">
              <div className="p-4">
                ...
                <div>
                  ...
                  <Link
                    href="/service"
                    className="btn btn-light me-3 mb-lg-0 px-lg-5 rounded-0 text-dark fw-bold"
                  >
                    Explore
                  </Link>
                  <Link
                    href="/about"
                    className="btn btn-outline-light px-lg-5 rounded-0 text-warning fw-bold"
                  >
                    Learn More
                  </Link>
                </div>
          ...
          <div className="container">
            <div className="row p-lg-5 p-3">
             ...
             <div className="d-flex">
                ...
                <Image className="mt-5 p-2
                 rounded-4" src={home} alt="Contact HandymanAHM" />
          
         
                <Image src={home2} className="p-2 rounded-4" alt="Contact HandymanAHM" />
            ...
            <div className="row p-lg-5 p-3">
            <div className="col-lg-6 col-md-6 col-12 about pb-lg-0 pb-4">
             <div className="d-flex">

          
                <Image className="mt-5 p-2
                 rounded-4" src={home4} alt="Contact HandymanAHM" />
          
         
                <Image src={home5} className="p-2 rounded-4" alt="Contact HandymanAHM" />
